...
This file is preparation, not evidence that the integration is registered or
public.

- Developer: Bananify Creative
- MCP endpoint: `https://tabs.blancbrowser.com/mcp`
- Tool: `create_tab_handoff`
- Authentication: none
- Privacy: `https://blancbrowser.com/privacy`
