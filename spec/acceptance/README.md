...
- Twenty-three feature files cover `F1–F24`, `F27–F28`, `F30–F37`, and `F39`; the
  ...
  `features.md` but no Gherkin transcription. F39's former bookmark-folder
  bindings were discarded. Eleven corrected desktop scenarios now exercise
  the session-backed flow, including the recoverability-gated quit prompt and
