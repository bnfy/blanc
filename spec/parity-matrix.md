...
| F34 | Glance reference pane | SHIPPED | PLANNED (iPhone Duo inner display only) | N/A | A desktop window can show one explicitly chosen local tab as a temporary, resizable reference pane; promotion swaps main/reference roles, dismissal leaves the tab open, and ownership never crosses a window or profile. | D11, D27 |
