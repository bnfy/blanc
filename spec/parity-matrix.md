...
| F2 | Tabs (create/close/switch/reopen/duplicate/pin/mute) | SHIPPED | PARTIAL | PLANNED | Same lifecycle + same reopen-closed and pin/mute semantics. Pins remain in their current group and lead it; ungrouped pins use a standalone shelf. Plain new tab is always ungrouped. An inactive tab may have its renderer discarded and rebuilt (D8, F31) without losing identity, title, address, or back-history. | D8 |
