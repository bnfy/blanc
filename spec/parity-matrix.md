...
| F12 | Ad/tracker blocking | SHIPPED | PLANNED | PLANNED | Ads/trackers blocked by default; per-tab shield count; per-site allow; global toggle. Filter data shared. | D1, D2 |
