...
| F35 | Start page layouts | SHIPPED | PLANNED | PLANNED | Five layouts (ledger/billboard/shelf/tally/mahjong), chosen by a synced setting with an in-page switcher; per-day blocked counts feed the tally chart; Mahjong embeds the local solitaire game; no horizontal overflow at any width. | — |
