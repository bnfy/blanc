...
> **September 12 supersession:** The owner-approved [current operating plan](follower-growth-operating-plan-2026-09-02.md) and [program state](growth-program.json) govern cadence, audience, execution and approval. September 4 automation/access evidence below is historical; never assume the heartbeat still exists. Current reconciliation is recorded in program state. The prior Meta campaign end date is historical and authorizes no extension.
