...
- `quick-switcher-1270x760.png` is the 6.5-second frame from the same video,
  after the complete `git` query and results are visible, exported with the
  same scale and pad.

The source demo was captured on September 3, 2026 from the installed packaged
public v1.15.0 macOS app in an isolated local profile with telemetry and search
suggestions disabled. Its full provenance and verification are recorded in
`../launch-copy.md` and
