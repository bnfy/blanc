...
- Unit coverage locks the Windows NSIS handoff, installer-side graceful-quit window, bounded process-close fallback, duplicate-restart guard, coalesced update checks, focus throttling, differential-download configuration, and manual-check feedback.
