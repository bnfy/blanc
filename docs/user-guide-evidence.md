...
Reviewed September 22, 2026 against public v1.21.0, commit
`159f274de47ffb32412420ae241d6337a416d0da`. The paths below refer to that tag,
...
| --- | --- | --- |
| Installation artifacts, signed native releases, updates | `package.json`, `scripts/release.sh`, `src/main/updater.js`; dated `docs/release-incidents/2026-09-21-v1.21.0.md` | Choose the actual published OS/architecture artifact; development does not auto-update. |
...
| Start page and standalone Mahjong | `src/renderer/pages/settings.html`, `src/renderer/pages/newtab.js`, `src/renderer/pages/mahjong.js`, `src/renderer/pages/mahjong-state.js`; v1.21.0 release incident | Four layouts remain on the Start Page; every footer opens Mahjong in a managed tab; records are device-local. |
