...
site deployment checks and both adjacent updater handoffs passed.
...
- Final launch baseline selection, release-bound asset refresh, and a fresh
  verified soak of at least 48 hours after the owner reschedules all four launch
  days. Release and updater success do not establish a launch freeze or shorten
  the required soak.
...
- On September 11, the owner confirmed both adjacent public v1.16.0 → v1.16.1
  macOS and Windows in-app updater handoffs succeeded. This confirmation closes
  the required flow for each platform: Blanc v1.16.0 discovered the public
  v1.16.1 metadata, downloaded the matching update, and invoked **Restart Now**.
