...
// route into a tab checks it. The rest (newtab, error, mahjong)
// open as ordinary tab pages.
const KNOWN_PAGES = new Set(['newtab', 'bookmarks', 'history', 'downloads', 'settings', 'error', 'shortcuts', 'mahjong', 'tab-import', 'tab-handoff']);
